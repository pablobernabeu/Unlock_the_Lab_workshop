...
| **4\. Quality of the Test (Methods & Data)** | **Flawed & Closed:** Tiny sample size. No control group. Data is secret/hidden.                     | **Acceptable:** Decent sample size. Standard methods. Data available upon request.                        | **Rigorous & Open:** Preregistration, large sample size, gold-standard controls, fully available materials and data. |
